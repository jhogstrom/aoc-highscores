...
def handle_record(msg: dict):
    print(f"Procesing: {msg}")
...
def process_messages(messages):
    ...
    for msg in messages:
        try:
            handle_record(json.loads(msg['body']))
            ...
            'Records': [
                {
                    ...
                    'body': '{"boardid": "34481", "sessionid": "53616c7465645f5f538e95e0d6938f92cb62df52473d36ce5e269046fd7d5eeaccd579aec170a66b1eec0f1eacfbdcfa", "title": "Leica foo bar fighters", "year": "2020"}',
                    'attributes': {
